...
class ConstituentJsonAdapterTest {
    ...
    fun whenCreateEntityFromAObject_shouldReturnProperModel() {
        ...
        assertThat(result.constituentULAN_URL).isEqualTo(constituentULANURLExpected)
        assertThat(result.constituentWikidata_URL).isEqualTo(constituentWikidataURLExpected)
